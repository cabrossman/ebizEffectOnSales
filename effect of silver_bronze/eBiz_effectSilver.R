...
#path <- 'S:\\eCommerce\\E-Commerce\\Analysis & Reporting\\Omni-Channel\\eBiz effect on FEI sls\\effect of silver_bronze\\eBiz_EFFECT_SILVER.sql'
#path <- 'S:\\eCommerce\\E-Commerce\\Analysis & Reporting\\Omni-Channel\\eBiz effect on FEI sls\\effect of silver_bronze\\eBiz_EFFECT_SILVER2.sql'
#path <- 'S:\\eCommerce\\E-Commerce\\Analysis & Reporting\\Omni-Channel\\eBiz effect on FEI sls\\effect of silver_bronze\\eBiz_EFFECT_SILVER3.sql'
#path <- 'S:\\eCommerce\\E-Commerce\\Analysis & Reporting\\Omni-Channel\\eBiz effect on FEI sls\\effect of silver_bronze\\eBiz_EFFECT_SILVER4.sql'
path <- 'S:\\eCommerce\\E-Commerce\\Analysis & Reporting\\Omni-Channel\\eBiz effect on FEI sls\\effect of silver_bronze\\eBiz_EFFECT_SILVER5.sql'
